...
from ._exceptions import APIStatusError, YolkenTest2Error
...
class YolkenTest2(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest2 client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST2_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest2WithRawResponse:
        return YolkenTest2WithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest2WithStreamedResponse:
        return YolkenTest2WithStreamedResponse(self)
...
class AsyncYolkenTest2(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest2 client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest2WithRawResponse:
        return AsyncYolkenTest2WithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest2WithStreamedResponse:
        return AsyncYolkenTest2WithStreamedResponse(self)
...
class YolkenTest2WithRawResponse:
    _client: YolkenTest2

    def __init__(self, client: YolkenTest2) -> None:
        self._client = client
...
class AsyncYolkenTest2WithRawResponse:
    _client: AsyncYolkenTest2

    def __init__(self, client: AsyncYolkenTest2) -> None:
        self._client = client
...
class YolkenTest2WithStreamedResponse:
    _client: YolkenTest2
...
class AsyncYolkenTest2WithStreamedResponse:
    _client: AsyncYolkenTest2
